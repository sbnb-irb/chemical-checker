...
def parse_chebi():
    ...
    return inchikey_paths,inchikey_inchi


def insert_to_database(inchikey_paths,inchikey_inchi):
...
def main():
    ...
    global dbname,chebi_molrepo,chebi_obo
    ...
    chebi_obo = os.path.join(downloadsdir,checkerconfig.chebi_obo)
    ...
    inchikey_paths,inchikey_inchi = parse_chebi()

    log.info( "Inserting to database")
    insert_to_database(inchikey_paths,inchikey_inchi)
