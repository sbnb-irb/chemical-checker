...
# Constants
tasks = [
  ( 'Raw MoA',                  'moa.py',                      'raw_moa' ),
  ( 'Raw Metabolic Genes',      'metabgenes.py',               'raw_metabgenes' ),
  ( 'Raw Crystals',             'crystals.py',                 'raw_crystals' ),
  ...
  ( 'Raw validation Sets',       'validation_sets.py',         'raw_validation' )
]
