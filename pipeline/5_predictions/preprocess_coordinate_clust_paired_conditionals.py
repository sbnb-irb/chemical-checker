...
def main():
    ...
    task_dir = os.path.join(inferTasksDir,'coordinate_clust_paired_conditionals')
    ...
    os.chdir(task_dir)
    task_script = WD + "/../../src/infer_similarity/coordinate_clust_paired_conditionals.py"
