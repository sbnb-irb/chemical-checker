...
def main():
    ...
    task_dir = os.path.join(inferTasksDir,'coordinate_paired_conditionals')
    ...
    os.chdir(task_dir)
    task_script = WD + "/../../src/infer_similarity/coordinate_paired_conditionals.py"
