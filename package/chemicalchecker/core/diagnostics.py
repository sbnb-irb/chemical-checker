...
class Diagnosis(object):
    ...
    def __init__(self, cc, sign, save=True, plot=True, n=10000):
    ...
    def _distance_distribution(self, n_pairs, metric):
        ...
        return self._returner(
            ...
            save = self.save,
            plot = self.plot,
            plotter_function = self.plotter.distance_distribution)
    ...
    def cross_coverage(self, sign, apply_mappings=False, try_conn_layer=False, save=None, **kwargs):
    ...
    def cross_roc(self, sign, n_samples=1000, n_neighbors=5, neg_pos_ratio=1, apply_mappings=False, try_conn_layer=False, metric='cosine', save=None, **kwargs):
        """Perform validations.
        ...
        """
        r = self.cross_coverage(sign, apply_mappings=apply_mappings, try_conn_layer=try_conn_layer, save=False)
    ...
    def across_coverage(self, datasets=None, exemplary=True, cctype="sign1", molset="full", **kwargs):
        ...
        for ds in datasets:
            ...
            results[ds] = self.cross_coverage(sign, save=False, **kwargs)
        return self._returner(
            results = results,
            fn = "across_coverage",
            save = self.save,
    ...
    def across_roc(self, datasets=None, exemplary=True, cctype="sign1", molset="full", **kwargs):
        ...
        for ds in datasets:
            sign = self.cc.get_signature(cctype, molset, ds)
            results[ds] = self.cross_roc(sign, save=False, **kwargs)
        return self._returner(
            results = results,
            fn = "across_roc",
            save = self.save,
