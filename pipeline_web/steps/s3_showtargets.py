...
class ShowTargets(BaseStep):
    ...
    def run(self):
        ...
        try:
            ...
            self.__log.error(e)
            raise Exception("Error while creating tables")
        ...
        ukb = UniprotKB(config_cc.DB.uniprot_db_version)
        ...
        try:
            ...
            self.__log.error(e)
            raise Exception("Error while filling showtargets_description")
        ...
        try:
            ...
            self.__log.error(e)
            raise Exception("Error while saving tables")
